...
我们还需要编写在服务端启动服务的代码 server.js，我们会使用到部分 node 原生提供的 api，片段代码如下：
...
![demo](./assets/vue-ssr2/4.jpeg)

> 下节，我将介绍下 mockjs，axios 怎么封装成公共函数便于使用
